...
export const AuthModalImproved = ({ isOpen, onClose }: AuthModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="bg-white border-0 text-gray-900 sm:max-w-md w-[calc(100vw-2rem)] max-h-[calc(100vh-2rem)] shadow-2xl rounded-2xl overflow-hidden p-0 overflow-y-auto">
