      ...
      height: 'clamp(120px, 25vh, 200px)'
        ...
        <div className="px-4 py-6 relative h-full flex flex-col justify-center">
          ...
          <div className="text-center flex-1 flex flex-col justify-center">
            ...
            <Button className="bg-white text-gray-900 hover:bg-gray-100 font-bold py-2 px-6 rounded-lg text-sm mx-auto transition-all duration-200" onClick={() => handleButtonClick(banner.button_link)}>
              {banner.button_image_url && <img src={banner.button_image_url} alt="" className="w-4 h-4 mr-2" />}
              {banner.button_text}
            </Button>
          </div>
          
          {banner.image_url && <div className="hidden md:flex justify-center mt-4">
