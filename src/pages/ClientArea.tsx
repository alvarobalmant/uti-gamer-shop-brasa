...
=======
>>>>>>> edd70fe7523335af5457f0a80b9d3c82d979d9e8
...
<<<<<<< HEAD
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="flex flex-wrap justify-center sm:flex sm:justify-center w-full">
            <TabsTrigger value="overview" className="flex-grow">Visão Geral</TabsTrigger>
            <TabsTrigger value="orders" className="flex-grow">Meus Pedidos</TabsTrigger>

            <TabsTrigger value="settings" className="flex-grow">Configurações</TabsTrigger>
          </TabsList>
