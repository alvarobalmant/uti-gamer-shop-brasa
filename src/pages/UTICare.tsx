...
import { Shield, Wrench, Clock, BadgeCheck, Play, ArrowRight } from 'lucide-react';
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Monte seu plano personalizado escolhendo seus equipamentos. 
                Cada item tem um valor mensal fixo. Simples assim.
              </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Cada equipamento tem um valor mensal fixo. Some os itens que deseja proteger.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            ...
            >
              <div className="text-4xl font-bold text-primary mb-2">R$ 25</div>
              <div className="text-muted-foreground">por console/mês</div>
            </motion.div>
            ...
            <motion.div
              ...
              className="p-6 rounded-xl bg-card border border-border text-center"
            >
              <div className="text-4xl font-bold text-primary mb-2">R$ 8</div>
              <div className="text-muted-foreground">por controle/mês</div>
            </motion.div>
            ...
            <motion.div
              ...
              className="p-6 rounded-xl bg-card border border-border text-center"
            >
              <div className="text-4xl font-bold text-primary mb-2">R$ 10</div>
              <div className="text-muted-foreground">por headset/mês</div>
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground mb-6">
              Monte seu plano em segundos. Escolha os equipamentos e veja o valor total.
            </p>
            <Button 
              size="lg" 
              className="gap-2"
