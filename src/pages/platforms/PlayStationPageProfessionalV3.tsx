...
const ProductCard = ({ product, index }) => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="group bg-white rounded-2xl overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl flex flex-col h-full border border-gray-100"
    ...
    >
      <div className="relative overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 aspect-[4/5]">
        ...
        {product.isNew && (
          <div className="absolute top-3 left-3 bg-gradient-to-r from-[#003791] to-blue-600 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg">
            NOVO
          </div>
        )}
        {product.isFeatured && (
          <div className="absolute top-3 left-3 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg">
            DESTAQUE
          </div>
        )}
      </div>
      ...
      <div className="p-6 flex flex-col justify-between flex-grow">
        <div className="min-h-[60px] mb-4">
          <h3 className="font-medium text-gray-900 text-base leading-tight tracking-tight line-clamp-2 mb-2">{product.name}</h3>
          {product.rating && (
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <span className="text-2xl font-bold text-[#003791]">
          ...
          <Button 
            ...
            className="w-full bg-gradient-to-r from-[#003791] to-blue-700 hover:from-blue-700 hover:to-[#003791] text-white font-bold py-3 px-4 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
          >
...
const PlayStationPageProfessionalV3 = () => {
  const { addToCart } = useCart();
  const navigate = useNavigate();
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section 
        ref={heroRef}
        className="relative py-32 md:py-40 bg-gradient-to-br from-[#003791] via-[#0041a3] to-[#003791] overflow-hidden flex items-center justify-center"
      >
        {/* Efeitos visuais de fundo */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-20 left-10 text-white/5 text-8xl animate-pulse">○</div>
          <div className="absolute top-40 right-20 text-white/5 text-12xl animate-bounce">□</div>
          <div className="absolute bottom-32 left-20 text-white/5 text-10xl animate-pulse">△</div>
          <div className="absolute bottom-20 right-10 text-white/5 text-8xl animate-bounce">✕</div>
        ...
        <div className="container mx-auto px-6 relative z-20">
          ...
          >
            <motion.h1
              ...
              className="text-5xl md:text-8xl font-light mb-8 leading-tight tracking-tight"
            >
              PLAY HAS NO <br />
            ...
            <motion.p
              ...
              className="text-xl md:text-2xl text-blue-100 mb-12 max-w-3xl mx-auto font-light tracking-tight leading-relaxed"
            >
            ...
            >
              <Button 
                size="lg" 
                className="bg-white text-[#003791] hover:bg-blue-50 font-bold px-10 py-4 text-xl rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-2xl"
              >
              ...
              <Button 
                size="lg" 
                className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#003791] font-bold px-10 py-4 text-xl rounded-2xl transition-all duration-300 shadow-xl"
              >
      ...
      {/* PlayStation 5 Consoles - Layout inspirado na GameStop */}
      <section className="py-32 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto font-light tracking-tight leading-relaxed">
      ...
      {/* Exclusivos PlayStation - Design mais limpo */}
      <section className="py-32 bg-gradient-to-br from-gray-900 via-[#003791] to-gray-900 text-white relative overflow-hidden">
        {/* Efeitos de fundo */}
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-blue-200 max-w-4xl mx-auto font-light tracking-tight leading-relaxed">
      ...
      {/* Acessórios PlayStation - Layout refinado */}
      ...
      {/* PlayStation Plus - Seção refinada */}
      <section className="py-32 bg-gradient-to-br from-[#003791] to-[#0041a3] text-white relative overflow-hidden">
        {/* Efeitos visuais */}
        <div className="absolute inset-0">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl mb-8 font-light tracking-tight leading-relaxed">
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-6 text-center">
          <p className="text-gray-400">© 2025 UTI dos Games. Todos os direitos reservados.</p>
        </div>
      </footer>
...
export default PlayStationPageProfessionalV3;
